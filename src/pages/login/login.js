...
const LoginPage = ({ path }) => {
    ...
    const handleRegister = async (data) => {
        ...
        try {
            const { data: response } = await axios.post(`${process.env.REACT_APP_BASE_URL}/customer/auth/register`, req, {
    ...
    const handleLogin = async (data) => {
        ...
        try {
            const { data: response } = await axios.post(`${process.env.REACT_APP_BASE_URL}/customer/auth/login`, req, {
                headers: { "Access-Control-Allow-Origin": "*" }
            });
